This is part of the LUFA library as included by the arduino IDE
It is included here in full in this Sangaboard repository as slight
variations of the LUFA library exist and finding/linking to the
correct one for our make file is painful.

The original readme is produced below, not everything remains true
as things like the demos have and bootloaders have not been copied
